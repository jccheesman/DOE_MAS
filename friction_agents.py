...
def setup_agents(llm):
    ...
    friction_modeler = Agent(
        ...
        backstory=(
            ...
            "(slope, land cover, permafrost, road networks, rivers) into "
            "composite cost surfaces using WhiteboxTools and the Trochim "
            "et al. methodology. Your job is to take raw rasters and produce "
            "a single friction number per edge in the graph database."
        ),
        verbose=True,
        llm=llm,
